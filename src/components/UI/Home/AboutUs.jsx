    ...
    <div className="mt-14">
      <div className="container mx-auto">
        <div className="flex flex-col-reverse lg:flex-row">
          ...
          <div className="basis-1/2 px-8 pb-10 pt-0 sm:px-10 lg:px-0 lg:pb-0 xl:pt-10 lg:pl-16">
            ...
            <p className="pt-10 text-base md:text-xl md:pr-24 text-center md:text-start">
              ...
              trang, EMMA luôn mong muốn truyền tải đến bạn những thông điệp tốt
              đẹp cùng với nguồn cảm hứng trẻ trung và tích cực.
            </p>
          </div>
        </div>
      </div>
