  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex items-center px-4 py-3 rounded-lg hover:bg-red-600 transition-colors duration-300 ${
          darkMode ? "bg-red-700 text-gray-200" : "bg-red-500 text-gray-900"
        }`}
      >
        <FaSignOutAlt
          className={`text-2xl mr-3 ${
