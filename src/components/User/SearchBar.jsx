...
const SearchBar = () => {
  ...
  return (
    <form className="relative flex items-center w-full max-w-md">
      ...
      />
      <button type="submit" className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-100 transition-colors duration-300">
